...
type AccountTab = 'cuenta' | 'pedidos';
type OrderState = 'confirmado' | 'preparando' | 'enviado' | 'entregado';
...
const orderSteps: OrderState[] = ['confirmado', 'preparando', 'enviado', 'entregado'];
...
function StatusSteps({ state }: { state: OrderState }) {
    ...
    <div className="bg-background">
      <section className="container py-8 sm:py-10">
        ...
        <div className="mb-6 grid gap-3 sm:grid-cols-2">
          <button
            type="button"
            onClick={() => setSearchParams({ tab: 'cuenta' })}
            className={cn(
              'flex min-h-11 items-center justify-center rounded-lg border px-4 py-2 text-sm font-semibold transition-colors',
              activeTab === 'cuenta'
            ...
            <article className="rounded-xl border bg-card p-5 lg:col-span-2">
              ...
              <dl className="grid gap-4 sm:grid-cols-2">
                <div className="rounded-lg border bg-background p-4">
                  <dt className="mb-1 text-xs uppercase tracking-wide text-muted-foreground">Nombre</dt>
                ...
                <div className="rounded-lg border bg-background p-4">
                  <dt className="mb-1 text-xs uppercase tracking-wide text-muted-foreground">Correo</dt>
                  <dd className="text-sm font-semibold text-foreground">{user.email}</dd>
                </div>
                <div className="rounded-lg border bg-background p-4">
                  <dt className="mb-1 text-xs uppercase tracking-wide text-muted-foreground">Rol</dt>
