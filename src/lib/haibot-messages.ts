...
const INTENT_MESSAGES: Record<HaibotWhatsAppIntent, string> = {
  'price-list':
    'Hola, soy cliente de Haitech. Me gustaría recibir la lista de precios actualizada. ¿Me pueden enviarla?',
  stock:
    'Hola, consulto desde Haitech. Necesito averiguar stock y disponibilidad de un producto. ¿Me pueden ayudar?',
  'whatsapp-bot':
    'Hola, vengo desde Haitech. Quiero comunicarme con el asistente/chatbot de Haitech por WhatsApp.',
  'schedule-service':
