...
interface ServicesDetailGalleryProps {
  item: ServiceCatalogItem;
  className?: string;
}

export function ServicesDetailGallery({ item, className }: ServicesDetailGalleryProps) {
...
interface ServicesDetailInclusionsProps {
  items: readonly string[];
  className?: string;
}

export function ServicesDetailInclusions({ items, className }: ServicesDetailInclusionsProps) {
  return (
