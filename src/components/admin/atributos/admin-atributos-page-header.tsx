...
interface AdminAtributosPageHeaderProps {
  className?: string;
  search: string;
...
export function AdminAtributosPageHeader({
  className,
  search,
  onSearchChange,
  onNewAttribute,
}: AdminAtributosPageHeaderProps) {
    ...
    >
      <div className="min-w-0">
        ...
        <p className="mt-0.5 text-xs text-muted-foreground">
          Configura y gestiona los atributos que describen tus productos.
        </p>
      </div>
      ...
      <div className="flex shrink-0 flex-wrap items-center gap-1.5">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            <DropdownMenuItem onSelect={() => onNewAttribute?.()}>
              Atributo de lista
            </DropdownMenuItem>
            <DropdownMenuItem onSelect={() => onNewAttribute?.()}>
              Atributo numérico
