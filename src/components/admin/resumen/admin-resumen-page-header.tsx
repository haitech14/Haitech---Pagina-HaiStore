...
export function AdminResumenPageHeader({ className }: AdminResumenPageHeaderProps) {
      ...
      <div className="flex shrink-0 flex-wrap items-center gap-2">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button type="button" className="h-9 gap-1.5 bg-[hsl(var(--admin-accent))] text-sm hover:bg-[hsl(var(--admin-accent-hover))]">
