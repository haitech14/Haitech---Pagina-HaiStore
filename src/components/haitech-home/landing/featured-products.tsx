    ...
    <section className={cn('w-full bg-white', className)} aria-labelledby="featured-products-heading">
      <div className="mb-4 flex flex-wrap items-end justify-between gap-2 sm:gap-3">
        <h2
          ...
          className="text-[14px] font-bold uppercase tracking-[0.03em] sm:text-[16px]"
          style={{ color: HAITECH_LANDING_COLORS.textPrimary }}
        >
        ...
        <Link
          to={allProductsHref}
          className="shrink-0 text-[11px] font-semibold transition-opacity hover:opacity-80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#e30613] focus-visible:ring-offset-2 sm:text-[12px]"
      ...
      >
        {products.map((product) => (
          <li key={product.id} className="min-w-[min(100%,240px)] snap-start sm:min-w-[250px] md:min-w-0">
