...
export function ProductDetailOverview({ content, className }: ProductDetailOverviewProps) {
  ...
  return (
    <div
      className={cn(
        'grid gap-8 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:items-start lg:gap-10',
        className,
      )}
    >
      <div className="flex flex-col justify-center space-y-4 lg:py-2">
        <h2 className="text-balance text-xl font-bold text-[#0f1f3d] sm:text-2xl">
          {overviewTitle}
        </h2>
