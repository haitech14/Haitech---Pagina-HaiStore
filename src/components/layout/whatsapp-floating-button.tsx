...
/** Separación desde el borde inferior (o la barra móvil); menor = más abajo en pantalla. */
const WHATSAPP_FAB_BOTTOM_REM = 0.5;
...
export function WhatsAppFloatingButton() {
  ...
  return (
    ...
    >
      <div
        className={cn(
          'mb-2 hidden max-w-[10.75rem] rounded-2xl rounded-br-md bg-white px-3 py-2 text-right shadow-[0_8px_24px_rgba(15,31,61,0.14)] ring-1 ring-black/5',
          'sm:block sm:max-w-[12.5rem] sm:px-3.5 sm:py-2.5',
        )}
        role="note"
      >
      ...
      <a
        ...
        aria-label="Cotizar por WhatsApp: ¿Necesitas una cotización? Te asesoramos por WhatsApp"
        className={cn(
