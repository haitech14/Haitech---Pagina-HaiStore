...
export const LANDING_CATEGORY = {
  ...
  repuestosCompatibles: 'Repuestos Compatibles',
  unidadesCompatibles: 'Unidades Compatibles',
...
const EXACT_CATEGORY_MAP = new Map([
  ...
  ['Repuestos Compatibles', landingInventoryCategory(LANDING_CATEGORY.repuestos, LANDING_CATEGORY.repuestosCompatibles)],
  ['Repuesto Compatible', landingInventoryCategory(LANDING_CATEGORY.repuestos, LANDING_CATEGORY.repuestosCompatibles)],
  ['Repuestos, Repuestos Compatibles', landingInventoryCategory(LANDING_CATEGORY.repuestos, LANDING_CATEGORY.repuestosCompatibles)],
  ['Unidades Compatibles', landingInventoryCategory(LANDING_CATEGORY.repuestosCompatibles, LANDING_CATEGORY.unidadesCompatibles)],
  ['Unidad Compatible', landingInventoryCategory(LANDING_CATEGORY.repuestosCompatibles, LANDING_CATEGORY.unidadesCompatibles)],
  ['Repuestos Compatibles, Unidades Compatibles', landingInventoryCategory(LANDING_CATEGORY.repuestosCompatibles, LANDING_CATEGORY.unidadesCompatibles)],
  ['Repuestos, Repuestos Compatibles, Unidades Compatibles', landingInventoryCategory(LANDING_CATEGORY.repuestos, LANDING_CATEGORY.unidadesCompatibles)],
