...
export function resolveCatalogListFormatoPapel(product: any): 'A4' | 'A3';
export function isDualFormatA4PrimaryProduct(product: any): boolean;
export function resolveFormatoPapelBadgeLabels(product: any): ('A4' | 'A3')[];
export function resolveFormatoPapelDisplayLabel(product: any): string | null;
