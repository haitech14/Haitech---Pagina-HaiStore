...
export const STATIC_SEO_ROUTES = [
  ...
  },
  {
    ...
    title: 'Preguntas frecuentes | Haitech',
    description:
  ...
  },
  {
    ...
    title: 'Distribuidor Autorizado Ricoh | Haitech',
    description:
  ...
  },
  {
    ...
    title: 'Foro | Haitech',
    description:
      'Comunidad técnica Haitech: consultas de firmware, mantenimiento, tóner y multifuncionales Ricoh. Comparte experiencias con técnicos y clientes en Perú.',
    pageName: 'Foro',
    jsonLdKind: 'webpage',
  },
  {
    pathname: '/terminos',
    title: 'Términos | Haitech',
    description:
      'Condiciones de venta, alquiler, garantías y envíos de Haitech, Distribuidor Autorizado Ricoh en Perú. Conoce tus derechos y obligaciones al comprar.',
    pageName: 'Términos',
    jsonLdKind: 'webpage',
  },
  {
    pathname: '/privacidad',
    title: 'Políticas | Haitech',
    description:
      'Cómo Haitech trata datos personales de clientes y visitantes: finalidades, conservación y derechos ARCO según la normativa peruana de protección de datos.',
    pageName: 'Políticas',
    jsonLdKind: 'webpage',
  },
];
